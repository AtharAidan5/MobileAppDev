...
class _HomeScreenState extends State<HomeScreen>
  ...
  final List<Widget> _screens = [
    ...
    const SettingsScreen(),     // NEW: Settings is at index 2
    const ProfileScreen(),      // Profile is at index 3
  ];
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildNavItem(2, Icons.settings_outlined, 'Settings'), // NEW: Settings at index 2
                _buildNavItem(3, Icons.person_outline, 'Profile'),   // Profile is now at index 3
              ],
            ),
          ),
        ),
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              ...
              // Removed the Settings action card (and Share was already removed)
            ],
          ),
