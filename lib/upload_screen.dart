...
class _UploadScreenState extends State<UploadScreen> {
  ...
  Future<void> _uploadFile() async {
    ...
    try {
      ...
      final downloadUrl = await _storageService.uploadCertificateFile(_selectedFile!);

      // 2. Add metadata to Firestore
      await _firestoreService.addCertificate({
        'name': _selectedFile!.path.split('/').last,
        'recipient': 'Uploaded Certificate', // Placeholder - consider adding a form field for this
